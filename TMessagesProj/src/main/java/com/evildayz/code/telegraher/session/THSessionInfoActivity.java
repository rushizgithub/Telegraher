...
public class THSessionInfoActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private THSessionInfoActivity.ListAdapter adapter;
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString(R.string.THAccountSessionInfo));
        ...
        listView.setAdapter(adapter = new THSessionInfoActivity.ListAdapter(context));
            ...
            switch (position) {
                case 0: {
                    if (((ThTextDetailCell) view).isChecked()) {
                        SharedConfig.activeAccounts.remove(accountId);
                    } else {
                        SharedConfig.activeAccounts.add(accountId);
                    }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            switch (holder.getItemViewType()) {
                ...
                case 7: {
                    ...
                    thTextDetailCell.setChecked(SharedConfig.activeAccounts.contains(accountId));
