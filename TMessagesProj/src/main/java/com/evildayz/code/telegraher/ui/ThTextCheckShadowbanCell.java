...
public class ThTextCheckShadowbanCell extends FrameLayout {
    ...
    public static final Property<ThTextCheckShadowbanCell, Float> ANIMATION_PROGRESS = new AnimationProperties.FloatProperty<ThTextCheckShadowbanCell>("animationProgress") {
        @Override
        public void setValue(ThTextCheckShadowbanCell object, float value) {
            object.setAnimationProgress(value);
            object.invalidate();
        }

        @Override
        public Float get(ThTextCheckShadowbanCell object) {
            return object.animationProgress;
        }
    };

    public ThTextCheckShadowbanCell(Context context) {
        this(context, 21);
    }

    public ThTextCheckShadowbanCell(Context context, int padding) {
        this(context, padding, false, null);
    }

    public ThTextCheckShadowbanCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        this(context, 21, false, resourcesProvider);
    }

    public ThTextCheckShadowbanCell(Context context, int padding, boolean dialog) {
        this(context, padding, dialog, null);
    }

    public long getTheFuckerId() {
        return theFuckerId;
    }

    public ThTextCheckShadowbanCell setTheFuckerId(long theFuckerId) {
        this.theFuckerId = theFuckerId;
        return this;
    }

    public ThTextCheckShadowbanCell(Context context, int padding, boolean dialog, Theme.ResourcesProvider resourcesProvider) {
        super(context);
